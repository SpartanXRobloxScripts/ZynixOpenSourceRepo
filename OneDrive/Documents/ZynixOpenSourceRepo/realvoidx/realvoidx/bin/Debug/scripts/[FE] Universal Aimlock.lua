--FE Simple AimLock Script | Works in most shooting games | Made by loooosk(dc) RobloxEnvision(rbx) | Released Nov 2021 | Working. 
...
local Active = false
local Lock = false
local Epitaph = .045 ---Note: The Bigger The Number, The More Prediction.
...
game.StarterGui:SetCore("SendNotification", {Title = "follow me on roblox", Text = "name: RobloxEnvision", Duration = 4,})